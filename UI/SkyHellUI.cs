...
namespace SkyHell.UI
{
    public class SkyHellUI : ModSystem
    {
        ...
        private void DrawHook(DrawDelegate orig, object uiModItem, SpriteBatch sb)
        {
            ...
            // 加载所需的资源
            var texture = ModContent.Request<Texture2D>("SkyHell/UI/Pure");
            var shader = ModContent.Request<Effect>("SkyHell/UI/GoldenX", AssetRequestMode.ImmediateLoad).Value;
